...
def reformat(dataset, labels):
  dataset = dataset.reshape((-1, in_height, in_width, num_channels)).astype(np.float32)
...
with graph.as_default():
  ...
  x = tf.placeholder(tf.float32, shape=(batch_size, in_height, in_width, num_channels))
