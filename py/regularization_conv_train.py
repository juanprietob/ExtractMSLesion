...
parser.add_argument('--use_valid', help='Use the valid dataset', type=bool, default=False)
...
if(use_valid):
  ...
  train_labels = data["valid_labels"]
else:
...
#train_dataset, train_labels = reformat(valid_dataset, valid_labels)
